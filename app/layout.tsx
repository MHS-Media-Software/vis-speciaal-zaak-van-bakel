...
export const metadata = {
  title: "Visspeciaalzaak van Bakel — Verse Vis, Maaltijden & Schotels in Oss",
  description: "Dé visspecialist van Oss al 27 jaar. Dagverse vis, eigen keuken, sushi, pokébowls, vis- en tapasschalen en de beroemde Osse Visplank. Kom langs aan de Terwaenen 30 of bestel op maat.",
};
